...
status, data = api("/api/manufacturing/qa?kb=default", "POST",
...
status, data = api("/api/manufacturing/qa?kb=111", "POST",
...
# 4. Code Parse
print("\n=== 4. Code Parse ===")
status, data = api("/api/manufacturing/code/parse?kb=default", "POST",
...
# 5. Fault Diagnosis
print("\n=== 5. Fault Diagnosis ===")
status, data = api("/api/manufacturing/fault-diagnosis?kb=default", "POST",
...
# 6. Dashboard
print("\n=== 6. Dashboard ===")
status, data = api("/api/manufacturing/dashboard?kb=default", timeout=15)
...
print("\n=== 7. Knowledge Graph Summary ===")
status, data = api("/api/manufacturing/knowledge-graph/summary?kb=default", timeout=15)
...
# 8. Fault Cases Stats
print("\n=== 8. Fault Cases Stats ===")
status, data = api("/api/manufacturing/fault-cases/stats?kb=default", timeout=15)
